...
$revistas = new WP_Query(array('post_type'=>'medico-em-dia'));
?>
...
<div class="push-content">
    ...
    <div class="page-title jarallax black-overlay-60" data-jarallax data-speed="0.6" style="background-image: url('http://www.ambr.org.br/images/hh1.jpg');">
        <div class="container">
            ...
            <h1 style="color:#fff;text-shadow:2px 2px #333;" color="white">Publicações <span class="italic libre-baskerville primary-color">AMBr</span></h1>
